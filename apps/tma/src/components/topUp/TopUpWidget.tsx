        ...
        {packages.map((pkg) => {
          ...
          return (
            <motion.button
              ...
              style={{
                borderColor: isActive ? 'oklch(78% 0.15 83)' : 'oklch(72% 0.04 73 / 0.5)',
                background: isActive ? 'oklch(32% 0.09 83 / 0.58)' : 'oklch(10% 0.035 252 / 0.48)',
                boxShadow: isActive ? '0 10px 20px oklch(78% 0.15 83 / 0.22)' : '0 5px 12px oklch(3% 0.02 252 / 0.26)',
              }}
              disabled={disabled}
