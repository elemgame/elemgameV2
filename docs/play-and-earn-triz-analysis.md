...
Статус на 2026-05-19: recommended Play-and-Earn направление реализовано в
`main` через задачи #72-#80. Упоминания `stake`, `winner payout` и `rake` ниже
относятся к снятой с production модели риска и сохранены как обоснование
перехода, а не как текущая спецификация.
